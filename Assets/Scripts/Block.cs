...
{
    Vector3Int position;
    Texture2D materialCell;
    BlockType blockType;

    List<Cell> cells = new();

    public Block(BlockType blockType, Vector3Int position, Texture2D materialCell)
    {
        ...
        switch (blockType)
        {
            case BlockType.BLOCKTYPE_L:
                CreateBlockL();
                break;
            case BlockType.BLOCKTYPE_O:
                CreateBlockO();
                break;
            case BlockType.BLOCKTYPE_Z:
                CreateBlockZ();
                break;
            case BlockType.BLOCKTYPE_T:
                CreateBlockT();
                break;
            case BlockType.BLOCKTYPE_I:
                CreateBlockI();
                break;
        }
    }
    ...
    public Texture2D MaterialCell { get => materialCell; set => materialCell = value; }
